...
/**
 * DavetYolla destek widget'ı. uygundavet'teki eşdeğerinin sadeleştirilmiş
 * adaptasyonu, sales modu yok, sadece destek/yardım. WhatsApp deep
 * link kullanıyor (sayı: 905546789780, uygundavet ile aynı hat).
 *
 * Panel sağ altta sabit, `SupportLauncher` butonuyla açılır kapanır.
 */
...
export function SupportWidget() {
  ...
  const handleTab = (next: Tab | "whatsapp") => {
    if (next === "whatsapp") {
      openWhatsApp();
      return;
    }
        ...
        >
          ...
          >
            <div
              ...
              style={{ color: DARK_TEXT, fontFamily: "Orbitron, sans-serif" }}
            >
              DavetYolla
            </div>
            <button
          ...
          <div className="px-5 pb-5">
            <h2
              className="text-[1.55rem] leading-[1.1] font-extrabold tracking-tight"
              style={{ color: DARK_TEXT, fontFamily: "Orbitron, sans-serif" }}
            >
              {t("greetingTitle")}
              <br />
              <span
                style={{ color: INK, fontFamily: "Merienda, serif" }}
          ...
          <div className="flex-1 rounded-t-[1.5rem] px-4 pt-4 pb-3 overflow-y-auto bg-white">
            <AnimatePresence mode="wait">
                ...
                >
                  <label className="flex items-center gap-2 px-4 h-12 rounded-xl bg-[#f5f6f3] border border-black/5 focus-within:border-[#d5d1ad] transition-colors">
                    ...
                    <input
                      ...
                      className="flex-1 bg-transparent outline-none text-sm text-[#1c1a1b] placeholder:text-[#555670]/70"
                  ...
                  {query ? (
                    <div className="rounded-xl bg-[#f5f6f3] border border-black/5 overflow-hidden">
                      {filteredHelp.length === 0 ? (
                        <div
                          className="px-4 py-6 text-sm text-[#555670] text-center"
                          style={{ fontFamily: "Space Grotesk, sans-serif" }}
                        >
                          {t("emptyResult")}
                        </div>
                        ...
                        filteredHelp.map((label, i, arr) => (
                          ...
                          >
                            <span
                              className="flex-1 text-sm text-[#1c1a1b]"
                              style={{
                    ...
                    <>
                      ...
                      >
                        ...
                        <span className="flex-1 min-w-0">
                          <span
                            className="block text-sm font-semibold text-[#1c1a1b]"
                            style={{ fontFamily: "Space Grotesk, sans-serif" }}
                          >
                            {t("whatsappTitle")}
                          </span>
                          <span
                            className="block text-xs text-[#555670] mt-0.5 line-clamp-2"
                            style={{ fontFamily: "Space Grotesk, sans-serif" }}
                          >
                            {t("whatsappDesc")}
                          </span>
              ...
              {tab === "help" && (
                ...
                >
                  <h3
                    ...
                    style={{ color: INK, fontFamily: "Orbitron, sans-serif" }}
                  >
                    {t("helpTitle")}
                  </h3>
                  <div className="rounded-xl bg-[#f5f6f3] border border-black/5 overflow-hidden">
              ...
              {tab === "news" && (
                ...
                >
                  ...
                  {[
                    { title: t("newsItem1Title"), desc: t("newsItem1Desc") },
                    { title: t("newsItem2Title"), desc: t("newsItem2Desc") },
                  ].map((item) => (
                    <div
                      key={item.title}
                    ...
                    >
                      <div
                        className="text-sm font-semibold text-[#1c1a1b]"
                        style={{ fontFamily: "Space Grotesk, sans-serif" }}
                      >
                        {item.title}
                      </div>
                      <div
                        className="text-xs text-[#555670] mt-1"
                        style={{ fontFamily: "Space Grotesk, sans-serif" }}
                      >
                        {item.desc}
                      </div>
