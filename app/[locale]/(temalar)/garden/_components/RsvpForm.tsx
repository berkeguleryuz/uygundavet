  ...
  return (
    <div className="w-full max-w-lg mx-auto">
      ...
      >
        ...
        <h2 className="font-merienda text-4xl text-[#2b3628]">
          {brideFirst} &amp; {groomFirst}
        </h2>
        <p className="font-sans text-sm text-[#2b3628]/55 mt-2">
          {weddingDate}
          {wedding.weddingTime && ` · ${wedding.weddingTime}`}
        </p>
        {wedding.venueName && (
          <p className="font-sans text-sm text-[#2b3628]/35 mt-1">
            {wedding.venueName}
          </p>
        )}
      </motion.div>
      ...
      <AnimatePresence mode="wait">
        {isSuccess ? (
          <motion.div
            ...
            className="bg-[#f5f3ed] rounded-[1.75rem] border border-[#4a7c59]/20 shadow-sm p-10 text-center space-y-5"
          >
            <motion.div
              initial={{ scale: 0, rotate: -30 }}
              animate={{ scale: 1, rotate: 0 }}
              transition={{ delay: 0.2, type: "spring", stiffness: 200 }}
              className="w-20 h-20 rounded-full bg-[#f9a620]/15 border border-[#f9a620]/40 flex items-center justify-center mx-auto"
            >
              <BloomIcon size={36} className="text-[#f9a620]" />
            </motion.div>
            <motion.h3
              initial={{ opacity: 0, y: 10 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.4 }}
              className="font-merienda text-2xl text-[#2b3628]"
            >
              {t("rsvpSuccessTitle")}
            </motion.h3>
            <motion.p
              ...
              className="font-sans text-sm text-[#2b3628]/55 leading-relaxed"
            >
          ...
          <motion.form
            ...
            className="bg-[#f5f3ed] rounded-[1.75rem] border border-[#4a7c59]/20 shadow-sm p-8 space-y-6"
          >
            <div className="space-y-2">
              <label htmlFor="rsvp-name" className="font-sans text-xs uppercase tracking-[0.15em] text-[#4a7c59]/80 font-semibold">
            ...
            <div className="space-y-2">
              <label htmlFor="rsvp-phone" className="font-sans text-xs uppercase tracking-[0.15em] text-[#4a7c59]/80 font-semibold">
            ...
            <div className="space-y-2">
              <label className="font-sans text-xs uppercase tracking-[0.15em] text-[#4a7c59]/80 font-semibold">
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  ...
                  className={cn(
                    ...
                    rsvpStatus === "confirmed"
                      ? "bg-[#4a7c59]/15 border-[#4a7c59] text-[#4a7c59]"
                      : "border-[#4a7c59]/20 bg-white text-[#2b3628]/40 hover:text-[#4a7c59]/70"
                  )}
                >
                ...
                <button
                  ...
                  className={cn(
                    "rounded-2xl border flex flex-col items-center justify-center gap-1.5 py-3.5 px-2 transition-all",
                    rsvpStatus === "declined"
                      ? "bg-[#b7472a]/10 border-[#b7472a]/50 text-[#b7472a]"
                      : "border-[#4a7c59]/20 bg-white text-[#2b3628]/40 hover:text-[#b7472a]/70"
                  )}
                >
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      type="button"
                      onClick={addGuest}
                      className="flex items-center gap-1.5 text-xs font-sans font-semibold text-[#4a7c59] hover:text-[#3a6447] transition-colors"
                    >
                      + {t("rsvpAddGuest")}
                    </button>
                  </div>
                    ...
                    {additionalGuests.map((guest) => (
                      ...
                      >
                        ...
                        <button
                          ...
                          className="w-12 h-12 rounded-2xl border border-[#4a7c59]/20 bg-white flex items-center justify-center text-[#2b3628]/40 hover:text-[#b7472a] hover:border-[#b7472a]/40 transition-all"
                        >
                          &times;
                        </button>
                      </motion.div>
            ...
            <div className="space-y-2">
              <label htmlFor="rsvp-note" className="font-sans text-xs uppercase tracking-[0.15em] text-[#4a7c59]/80 font-semibold">
            ...
            <button
              ...
              className="w-full h-12 rounded-2xl bg-[#4a7c59] text-[#f5f3ed] font-bold font-sans text-sm tracking-[0.1em] uppercase transition-all hover:bg-[#3a6447] disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
