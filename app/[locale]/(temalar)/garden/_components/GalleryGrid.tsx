          ...
          <div className="bg-[#f5f3ed] rounded-[1.5rem] border border-[#4a7c59]/20 shadow-sm p-4">
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-3">
              <div className="relative flex-1">
                <UserIcon
                  size={16}
                  className="pointer-events-none absolute left-3.5 top-1/2 -translate-y-1/2 text-[#4a7c59]"
                />
                <input
                  type="text"
                  value={uploaderName}
                  ...
                  className="w-full h-11 rounded-xl border border-[#4a7c59]/20 bg-white pl-9 pr-4 text-base sm:text-sm text-[#2b3628] placeholder:text-[#2b3628]/40 focus:border-[#4a7c59] focus:outline-none focus:ring-2 focus:ring-[#4a7c59]/15 transition-all font-sans"
                />
              </div>
              ...
              <button
                ...
                className={cn(
                  "h-11 px-5 rounded-xl font-sans text-xs font-semibold tracking-[0.1em] uppercase flex items-center justify-center gap-2 transition-all shrink-0",
                  isUploading
