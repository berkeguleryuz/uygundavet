export type GoldenLocale = "tr" | "en" | "de";
interface T {
...
const tr: T = {
  ...
  heroTagline:"Altın Saatte Bir Aşk",heroCtaButton:"Davetiyeyi Yanıtla",heroScrollHint:"Aşağı Akış",
  countdownLabel:"Geri Sayım",countdownHeading:"Altın Güne Doğru",countdownDays:"Gün",countdownHours:"Saat",countdownMinutes:"Dakika",countdownSeconds:"Saniye",
  storyLabel:"Hikâyemiz",storyText:"Her sevginin bir altın anı vardır. Bizimkini sizlerle paylaşmaktan mutluluk duyuyoruz.",storyCtaButton:"Hikayemizi Okuyun",
  venueLabel:"Mekân & Etkinlik",venueAddress:"Adres",venueDate:"Tarih",venueTime:"Saat",venueCtaButton:"Detayları Görün",
  galleryLabel:"Galeri",galleryHeading:"Altın Anıların Arşivi",galleryCtaButton:"Tüm Galeriyi Gör",
...
const en: T = {
  ...
  heroTagline:"Love in the Golden Hour",heroCtaButton:"RSVP Now",heroScrollHint:"Fade In",
  countdownLabel:"Countdown",countdownHeading:"Toward the Golden Day",countdownDays:"Days",countdownHours:"Hours",countdownMinutes:"Minutes",countdownSeconds:"Seconds",
  storyLabel:"Our Story",storyText:"Every love has a golden moment. We'd love to share ours with you.",storyCtaButton:"Read Our Story",
  venueLabel:"Venue & Event",venueAddress:"Address",venueDate:"Date",venueTime:"Time",venueCtaButton:"View Details",
  galleryLabel:"Gallery",galleryHeading:"Archive of Golden Memories",galleryCtaButton:"View Full Gallery",
  ...
  eventLabel:"Event Details",eventScheduleHeading:"Schedule",eventFamilyHeading:"Families",eventBrideFamily:"Bride's Family",eventGroomFamily:"Groom's Family",eventDressCode:"Warm Chic",
...
const de: T = {
  ...
  heroTagline:"Liebe zur goldenen Stunde",heroCtaButton:"Jetzt antworten",heroScrollHint:"Eintauchen",
  countdownLabel:"Countdown",countdownHeading:"Zum goldenen Tag",countdownDays:"Tage",countdownHours:"Stunden",countdownMinutes:"Minuten",countdownSeconds:"Sekunden",
  storyLabel:"Unsere Geschichte",storyText:"Jede Liebe hat ihre goldene Stunde. Wir teilen unsere gerne mit Ihnen.",storyCtaButton:"Geschichte lesen",
  venueLabel:"Ort & Event",venueAddress:"Adresse",venueDate:"Datum",venueTime:"Uhrzeit",venueCtaButton:"Details",
  galleryLabel:"Galerie",galleryHeading:"Archiv goldener Erinnerungen",galleryCtaButton:"Gesamte Galerie",
  ...
  eventLabel:"Veranstaltung",eventScheduleHeading:"Programm",eventFamilyHeading:"Familien",eventBrideFamily:"Familie der Braut",eventGroomFamily:"Familie des Bräutigams",eventDressCode:"Warm Chic",
...
const translations: Record<GoldenLocale, T> = { tr, en, de };
let currentLocale: GoldenLocale = "tr";
export function setGoldenLocale(locale: GoldenLocale) { currentLocale = locale; }
export function t(key: keyof T): string { return translations[currentLocale][key] || translations.tr[key] || key; }
export function getTranslations(locale: GoldenLocale): T { return translations[locale] || translations.tr; }
