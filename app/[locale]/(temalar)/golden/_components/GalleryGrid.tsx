            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-3">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="w-full h-11 rounded-xl border border-[#c1666b]/25 bg-white pl-9 pr-4 text-sm text-[#4a403a] placeholder:text-[#4a403a]/40 focus:border-[#c1666b] focus:outline-none focus:ring-2 focus:ring-[#c1666b]/20 transition-all font-sans"
                />
              </div>
