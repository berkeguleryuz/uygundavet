            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-3">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="w-full h-11 rounded-lg border border-[#1a1a2e]/10 bg-white pl-9 pr-3 text-base sm:text-sm text-[#1a1a2e] placeholder:text-[#a09ba6] focus:border-[#b49a7c] focus:outline-none focus:ring-1 focus:ring-[#b49a7c]/20 transition-all font-sans"
                />
              </div>
