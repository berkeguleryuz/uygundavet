...
export interface WeddingData {
  groomName: string; brideName: string; weddingDate: string; weddingTime: string;
  venueName: string; venueAddress: string; address: string;
  hasGallery: boolean; hasMemoryBook: boolean; selectedTheme: string; inviteCode: string;
  groomFamily: FamilyInfo | null; brideFamily: FamilyInfo | null;
