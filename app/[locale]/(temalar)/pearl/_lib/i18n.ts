export type PearlLocale = "tr" | "en" | "de";
interface T {
...
const tr: T = {
  ...
  heroTagline:"Evleniyoruz",heroCtaButton:"Davetiyeyi Yanıtla",heroScrollHint:"Aşağı Kaydır",
...
const en: T = {
  ...
  heroTagline:"We're Getting Married",heroCtaButton:"RSVP Now",heroScrollHint:"Scroll Down",
...
const de: T = {
  ...
  heroTagline:"Wir heiraten",heroCtaButton:"Jetzt antworten",heroScrollHint:"Nach unten",
...
const translations: Record<PearlLocale, T> = { tr, en, de };
let currentLocale: PearlLocale = "tr";
export function setPearlLocale(locale: PearlLocale) { currentLocale = locale; }
export function t(key: keyof T): string { return translations[currentLocale][key] || translations.tr[key] || key; }
export function getTranslations(locale: PearlLocale): T { return translations[locale] || translations.tr; }
