    ...
    >
      <div className="flex items-start justify-between gap-3 mb-3">
        <div className="flex items-center gap-3">
          <div className="size-8 rounded-full bg-gradient-to-r from-[#b8a088] to-[#c4a296] flex items-center justify-center shrink-0">
        ...
        {pending && (
          <span className="shrink-0 inline-flex items-center rounded-full bg-[#8a7d6d]/10 border border-[#8a7d6d]/30 px-2.5 py-0.5 text-[10px] font-sans text-[#8a7d6d]">
