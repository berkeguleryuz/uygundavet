          ...
          <div className="bg-white rounded-3xl border border-[#1c1917]/[0.06] shadow-sm p-4">
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-3">
              <div className="relative flex-1">
                <UserIcon
                  size={16}
                  className="pointer-events-none absolute left-3.5 top-1/2 -translate-y-1/2 text-[#b8a088]"
                />
                <input
                  type="text"
                  value={uploaderName}
                  ...
                  className="w-full h-11 rounded-xl border border-[#1c1917]/10 bg-[#faf6f1] pl-9 pr-4 text-base sm:text-sm text-[#1c1917] placeholder:text-[#1c1917]/40 focus:border-[#b8a088] focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#b8a088]/15 transition-all font-sans"
                />
              </div>
