...
const inputClassDark =
  "w-full h-12 rounded-2xl border border-white/10 bg-white/5 px-4 text-base sm:text-sm text-white placeholder:text-white/30 focus:border-[#b8a088] focus:outline-none focus:ring-2 focus:ring-[#b8a088]/20 transition-all font-sans";
