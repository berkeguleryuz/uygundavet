export type RoseLocale = "tr" | "en" | "de";
interface T {
...
const translations: Record<RoseLocale, T> = { tr, en, de };
let currentLocale: RoseLocale = "tr";
export function setRoseLocale(locale: RoseLocale) { currentLocale = locale; }
export function t(key: keyof T): string { return translations[currentLocale][key] || translations.tr[key] || key; }
export function getTranslations(locale: RoseLocale): T { return translations[locale] || translations.tr; }
