    ...
    <>
      <nav className="fixed top-5 left-0 right-0 z-[60] px-6 md:px-10 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div className={cn(
            "flex items-center rounded-full backdrop-blur-sm border overflow-hidden",
        ...
        >
          <button onClick={() => { setIsOpen(false); setIsContactOpen(true); }} className="group/talk rounded-full bg-[#1c1a1b] text-white flex items-center justify-center h-14 px-10 cursor-pointer overflow-hidden">
